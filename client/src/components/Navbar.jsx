...
const Navbar = () => {
    ...
    const [user, setuser] =useState(true);//to identify weather user is logged in or logged out so, depending upon that we can give differnt navbars and other things
  ...
  return (
    ...
    {/*we should always add another div inside the main div only not outside the main div its an rule */}
      <div>
        {
        user ?
        <div className='flex items-center gap-2 sm:gap-3 '>
            ...
            <p className='text-gray-600 max-sm:hidden pl-4'>Hi, Sohail</p>
